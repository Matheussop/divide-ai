...
import { Download, MessageCircle, PieChart } from "lucide-react";
...
export function MonthlyReportPage({ monthKey, monthLabel, expenses, categories, users }: MonthlyReportPageProps) {
